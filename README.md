...
| --- | --- |
| **Live hero** | Real-time scene using real downloaded photos: a real stadium photo backdrop with real footballer cutout images moving independently — each walks, sprints, juggles, dances & sings (with floating notes) or cheers on its own random schedule, with bouncing balls, crowd, floodlights and mouse parallax |
